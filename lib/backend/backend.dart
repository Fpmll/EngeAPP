...
import 'schema/eng_usinas_record.dart';
...
export 'schema/eng_usinas_record.dart';
...
/// Functions to query EngUsinasRecords (as a Stream and as a Future).
Future<int> queryEngUsinasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EngUsinasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EngUsinasRecord>> queryEngUsinasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      EngUsinasRecord.collection,
      EngUsinasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EngUsinasRecord>> queryEngUsinasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
